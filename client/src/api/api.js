...
// Use development URL in dev mode, production URL will be same domain
const isDevelopment = import.meta.env.MODE === "development";
const serverURL = isDevelopment ? "http://localhost:3000" : ""; // Empty string for same domain in production
